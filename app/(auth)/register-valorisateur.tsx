...
export default function RegisterValorisateurScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <AppLogo size={40} />
        <Text style={styles.roleTitle}>Valorisateur</Text>
        ...
        <TextInput style={styles.input} placeholder="Entreprise" placeholderTextColor="#6d8f4a" />
        ...
        <Pressable
          style={styles.cta}
          onPress={() => {
            setRole('valorisateur');
            router.replace('/(valorisateur)/dashboard');
          }}>
