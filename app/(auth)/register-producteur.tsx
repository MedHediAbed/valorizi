...
export default function RegisterProducteurScreen() {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <TextInput style={styles.input} placeholder="Producteur" placeholderTextColor="#6d8f4a" />
        ...
        <Pressable
          ...
          onPress={() => {
            setRole('producteur');
            router.replace('/(producteur)/dashboard');
          }}>
