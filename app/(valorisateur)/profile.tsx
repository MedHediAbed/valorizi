...
export default function ValorisateurProfileScreen() {
    ...
    <SafeAreaView style={styles.safe} edges={['top', 'left', 'right']}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Card>
          ...
          <Row icon="notifications-outline" label="Notifications" value="ON" onPress={() => router.push('/profile-notifications')} />
